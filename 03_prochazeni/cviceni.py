# ---------------------------------------------
#  Cvičení – procházení a kombinace
# ---------------------------------------------
# Tady si spojíš dohromady všechno z téhle lekce: funkce, cyklus for
# i podmínky. Piš svůj kód pod každý úkol a spusť soubor (tlačítko Run).
